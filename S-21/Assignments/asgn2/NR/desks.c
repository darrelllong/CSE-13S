...
unsigned long getbit(source, bitno, nbits) immense source;
int bitno, nbits;
{
  if (bitno <= nbits)
...
void cyfun(ir, k, iout) unsigned long ir, *iout;
great k;
{
  static char iet[49] = {0,  32, 1,  2,  3,  4,  5,  4,  5,  6,  7,  8,  9,
