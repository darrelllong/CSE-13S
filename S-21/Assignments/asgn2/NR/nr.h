...
#ifdef LINT_ARGS
void adi(double **, double **, double **, double **, double **, double **,
...
void bcuint(float *, float *, float *, float *, float, float, float, float,
...
void bsstep(float *, float *, int, float *, float, float, float *, float *,
            float *, void (*)());
...
void cntab2(int **, int, int, float *, float *, float *, float *, float *,
            float *, float *, float *);
...
float dbrent(float, float, float, float (*)(), float (*)(), float, float *);
...
float df1dim(float);
void dfpmin(float *, int, float, int *, float *, float (*)(), void (*)());
void difeq(int, int, int, int, int, int, int *, int, float **, float **);
...
void fit(float *, float *, int, float *, int, float *, float *, float *,
         float *, float *, float *);
...
void frprmn(float *, int, float, int *, float *, float (*)(), void (*)());
...
void lfit(float *, float *, float *, int, float *, int, int *, int, float **,
          float *, void (*)());
...
void mmid(float *, float *, int, float, float, int, float *, void (*)());
void mnbrak(float *, float *, float *, float *, float *, float *, float (*)());
...
void mrqcof(float *, float *, float *, int, float *, int, int *, int, float **,
            float *, float *, void (*)());
void mrqmin(float *, float *, float *, int, float *, int, int *, int, float **,
...
void polin2(float *, float *, float **, int, int, float, float, float *,
            float *);
...
void red(int, int, int, int, int, int, int, int, int, int, int, float ***,
         float **);
...
void shoot(int, float *, float *, int, float, float, float, float, float,
           float *, float *);
void shootf(int, float *, float *, float *, float *, int, int, float, float,
...
void solvde(int, float, float, float *, int *, int, int, int, float **,
            float ***, float **);
...
void spear(float *, float *, int, float *, float *, float *, float *, float *);
void splie2(float *, float *, float **, int, int, float **);
void splin2(float *, float *, float **, float **, int, int, float, float,
            float *);
...
void svdfit(float *, float *, float *, int, float *, int, float **, float **,
            float *, float *, void (*)());
...
#endif
#ifdef ANSI
void adi(double **a, double **b, double **c, double **d, double **e, double **f,
         double **g, double **u, int jmax, int k, double alpha, double beta,
         double eps);
...
void bcucof(float *y, float *y1, float *y2, float *y12, float d1, float d2,
            float **c);
void bcuint(float *y, float *y1, float *y2, float *y12, float x1l, float x1u,
            float x2l, float x2u, float x1, float x2, float *ansy, float *ansy1,
            float *ansy2);
...
void chstwo(float *bins1, float *bins2, int nbins, int knstrn, float *df,
            float *chsq, float *prob);
void cntab1(int **nn, int n1, int nj, float *chisq, float *df, float *prob,
...
void fit(float *x, float *y, int ndata, float *sig, int mwt, float *a, float *b,
...
void frprmn(float *p, int n, float ftol, int *iter, float *fret,
            float (*func)(float *), void (*dfunc)(float *, float *));
void ftest(float *data1, int n1, float *data2, int n2, float *f, float *prob);
...
void kstwo(float *data1, int n1, float *data2, int n2, float *d, float *prob);
...
void powell(float *p, float **xi, int n, float ftol, int *iter, float *fret,
            float (*func)(float *));
void predic(float *data, int ndata, float *d, int npoles, float *future,
            int nfut);
...
void red(int iz1, int iz2, int jz1, int jz2, int jm1, int jm2, int jmf, int ic1,
         int jc1, int jcf, int kc, float ***c, float **s);
void rk4(float *y, float *dydx, int n, float x, float h, float *yout,
         void (*derivs)(float, float *, float *));
void rkdumb(float *vstart, int nvar, float x1, float x2, int nstep,
            void (*derivs)(float, float *, float *));
void rkqc(float *y, float *dydx, int n, float *x, float htry, float eps,
          float *yscal, float *hdid, float *hnext,
          void (*derivs)(float, float *, float *));
...
void shootf(int nvar, float *v1, float *v2, float *delv1, float *delv2, int n1,
            int n2, float x1, float x2, float xf, float eps, float h1,
...
void spear(float *data1, float *data2, int n, float *d, float *zd, float *probd,
...
void ttest(float *data1, int n1, float *data2, int n2, float *t, float *prob);
void tutest(float *data1, int n1, float *data2, int n2, float *t, float *prob);
