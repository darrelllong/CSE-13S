...
typedef enum elm { SIN, COS, TAN, ASIN, ACOS, ATAN, EXP, LOG, POW, SQRT, XYZZY } elem;
...
#define FMT " %7.4lf % 16.8lf % 16.8lf % 16.10lf\n"
...
#define EDGE 0.01
            ...
            case ASIN: {
                diff("Asn", arcSin, asin, -1.0, 1.0, STEP_SZ);
                break;
            }
            case ACOS: {
                diff("Acs", arcCos, acos, -1.0, 1.0, STEP_SZ);
                break;
            }
            case ATAN: {
                diff("Atn", arcTan, atan, 1.0, 10.0, STEP_SZ);
                break;
            }
            case EXP: {
            ...
            case SQRT: {
                diff("Srt", Sqrt, sqrt, 0.0, 3.0, STEP_SZ);
                break;
            }
            default: {
